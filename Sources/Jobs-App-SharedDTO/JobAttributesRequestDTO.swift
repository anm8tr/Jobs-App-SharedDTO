...
public struct JobAttributesRequestDTO: Codable {
    ...
    public init(status: String, name: String, address: String, city: String, state: String, /*zipcode: Int,*/ phoneNumberOne: String, phoneNumberTwo: String, email: String, contacted: String, appointmentSet: String, appointmentDate: Date, jobStatus: String, invoiced: String, invoiceAmount: Double, notes: String) {
        self.status = status
        self.name = name
